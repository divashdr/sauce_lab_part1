...
public class SampleSauceTextInputTest extends SampleSauceTestBase {
	...
	public void verifyEmailInputTest(String browser, String version, String os, Method method)
		...
		/*
		 * enterEmailText page is an exposed "service", which interacts with the
		 * email input field element by sending text to it.
		 */
		page.enterEmailText(emailInputText);

		/*
		 * Assertions should be part of test and not part of Page object. Each
		 * test should be verifying one piece of functionality (atomic testing)
		 */
	...
	public void verifyCommentInputTest(String browser, String version, String os, Method method)
		...
		/*
		 * enterCommentText page is an exposed "service", which interacts with
		 * the email input field element by sending text to it.
		 */
