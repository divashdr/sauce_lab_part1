...
public class SampleSauceTestBase implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
	...
	// Sauce username
	public String username = "divash_d_r";

	// Sauce access key
	public String accesskey = "e39695f9-4600-4894-ad74-37c1df175e62";
	...
	public static Object[][] sauceBrowserDataProvider(Method testMethod) {
		return new Object[][] { new Object[] { "internet explorer", "11", "Windows 8.1" },
				new Object[] { "chrome", "41", "Windows XP" }, new Object[] { "safari", "7", "OS X 10.9" },
